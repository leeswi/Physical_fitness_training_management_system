%rebase base title='分组管理  日常训练管理系统',position='分组管理',managetopli="active open",adddepartment="active"
    ...
    <div class="modal-dialog" >
      <div class="modal-content" id="contentDiv">
         <div class="widget-header bordered-bottom bordered-blue ">
           ...
           <span class="widget-caption themeprimary" id="modalTitle">添加分组</span>
        </div>
...
$(function(){
    ...
    function getinfo(value,row,index){
        ...
        return [
            '<a href="/editdepartment/'+rowobj['id']+'" class="btn-sm btn-info">',
             ...
             '</a>',' ',
            '<a href="/deldepartment" class="btn-sm btn-danger">',
    ...
    */
    $("#subBtn").click(function(){
           ...
           $.post(postUrl,{name:name,chargeman:chargeman},function(data){
                  if(data==0){
                    $('#myModal').modal('hide');
